    ...
    reducers: {
        ...
        selectBookAction: (state, action) => {
            ...
            if (checked) {
                ...
                // state.selected.push(bookId);
            } else {
                // console.log("del");
                // console.log(bookId, typeof (bookId));
                // // state.selected.filter(book => book.book_id != bookId);
                // state.selected.filter(id => id != bookId);
                // const index = state.selected.indexOf(selectedBook);
...
export const { getCartAction, addBookIntoCartAction, deleteCart, deleteBookAction, increaseQuantityOrderedAction, decreaseQuantityOrderedAction, selectBookAction } = cartSlice.actions;
